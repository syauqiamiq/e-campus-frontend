					...
					<CardContent>
								...
								<div className="flex gap-3 px-32 py-6">
									<div className="flex flex-col justify-center gap-3 items-center">
										<div className="text-sm font-light">
											<p className="text-lg font-bold">Informasi Data SKPI</p>
											<ul className="list-disc">
												<li>
													Mohon untuk mengisi data dengan lengkap dan benar
													beserta bukti dokumen.
												</li>
												<li>Dokumen harus berformat PDF</li>
						...
						<div className="container mx-auto grid grid-cols-12 gap-10 py-10 justify-center items-center">
							<div className=" col-span-6">
								<h1 className="text-base font-medium">Uraian Kegiatan :</h1>
							</div>
							<div className=" col-span-6">
								<TextField
									fullWidth
							...
							<div className=" col-span-6">
								<h1 className="text-base font-medium">Jenis Kegiatan :</h1>
							</div>
							<div className="col-span-6">
								<TextField
									helperText=""
							...
							<div className=" col-span-6">
								<h1 className="text-base font-medium">
									Kompetensi, Tingkat, Partisipasi :
								</h1>
							</div>
							<div className=" col-span-6">
								<Box>
							...
							<div className=" col-span-6 ">
								<h1 className="text-sm font-medium">Upload Dokumen PDF :</h1>
							</div>
							<div className="col-span-6 bg-gray-300 rounded-lg shadow-lg px-6 items">
								<Button
									component="label"
									variant="contained"
							...
							<div className="col-span-12">
								<FormControlLabel
									...
									label="Dengan ini saya menyatakan bahwa, data yang saya isikan di formulir ini adalah benar adanya sesuai dengan bukti-bukti yang ada."
								/>
							</div>
