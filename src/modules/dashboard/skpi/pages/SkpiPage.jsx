...
const rows = [
	...
	{
		id: 2,
		uraiankegiatan: "Seminar Nusa Talent",
		partisipasi: "Peserta",
		skor: 100,
		status: "Disetujui",
	},
	{
		id: 3,
		uraiankegiatan: "Seminar Infinite Learning",
		partisipasi: "Peserta",
		skor: 100,
		status: "Disetujui",
	},
	{
		id: 4,
		uraiankegiatan: "Seminar Alfiliasi",
		partisipasi: "Panitia",
		skor: 100,
		status: "Disetujui",
	},
	{
		id: 5,
		uraiankegiatan: "Seminar Accounting",
		partisipasi: "Peserta",
		skor: 100,
		status: "Disetujui",
	},
	{
		id: 6,
		uraiankegiatan: "Pengabdian Masyarakat",
		partisipasi: "Peserta",
		skor: 100,
		status: "Disetujui",
	},
	{
		id: 7,
		uraiankegiatan: "Seminar 8 Maret",
		partisipasi: "Peserta",
		skor: 100,
		status: "Disetujui",
	},
	{
		id: 8,
		uraiankegiatan: "Seminar 7 April",
		partisipasi: "Peserta",
		skor: 100,
		status: "Disetujui",
	},
	{
		id: 9,
		uraiankegiatan: "Seminar Jaringan",
		partisipasi: "Panitia",
		skor: 100,
		status: "Disetujui",
	},
...
const columns = [
	{
		field: "uraiankegiatan",
		headerName: "Uraian Kegiatan",
		width: 250,
		headerClassName: "super-app-theme--header",
	},
	{
		field: "partisipasi",
		headerName: "Partisipasi",
		width: 250,
		headerClassName: "super-app-theme--header",
	},
	{
			...
			<div className="bg-white rounded-lg">
				...
				<div className="col-span-12 justify-center flex mx-5 items-center py-2">
					<div className="w-full md:w-72 mt-2 mb-2">
						<CustomButton type="contained" title="Download Skpi" />
					</div>
				</div>
			</div>
		</DashboardLayout>
