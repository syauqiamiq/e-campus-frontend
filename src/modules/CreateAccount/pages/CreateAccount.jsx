...
const CreateAccount = () => {
                ...
                <div className="col-span-12 md:col-span-12 md:p-12 p-8 justify-center w-full h-full align-middle items-center">
                    <Card sx={{ minWidth: 10}} className="rounded-3xl">
                        <CardContent>                         
                            ...
                            <Typography sx={{ mb: 3, mt:1}} color="text.first" gutterBottom >
                                <h3 className="font-bold text-2xl">Daftar Akun</h3>
                            </Typography>
            <Divider className="w-full hidden md:block" />
                            <Typography sx={{ mb: 1, mt: 3 }} color="text.first">
                                <h3 className="font-bold text-2xl text-center">Informasi Akun</h3>
                            </Typography>
	...
	<div className="w-full md:w-72 mt-5 mb-5">
		<CustomButton type="contained" title="Daftar Akun" />
	</div>
	</div>                              
        </div>
    </CardContent>
